...
void userHandle(void)
{
    ...
    currentDataPoint.valuespeed = IC_GetFreq();//Add Sensor Data Collection
    currentDataPoint.valuewater =WATER_GetData() ;//Add Sensor Data Collection
    currentDataPoint.valuetemp =temperature/10 ;//Add Sensor Data Collection
